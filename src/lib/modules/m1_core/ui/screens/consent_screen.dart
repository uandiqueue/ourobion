...
class _ConsentScreenState extends State<ConsentScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Data Permissions')),
      body: SafeArea(
        child: Column(
          children: [
            Expanded(
              child: ListView(
                ...
                children: [
                  const Text(
                    'Choose what data you\'d like to track. You can change this any time in Settings.',
                    style: TextStyle(fontSize: 15),
                  ),
                  const SizedBox(height: 24),
                  SwitchListTile(
                    title: const Text('Gut & Hydration Tracking'),
                    subtitle: const Text('Log stool form, urine colour, and daily symptoms'),
