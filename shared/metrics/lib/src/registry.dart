...
const List<MetricDefinition> kMetrics = [
  ...
  MetricDefinition(
    ...
    signal: MetricSignal(deadbandK: 1.0),
    ui: MetricUi(label: 'Stool count', inputType: 'quick_count'),
    status: 'active',
    introducedIn: 'phase1',
    deprecatedAt: null,
  ),
  ...
  MetricDefinition(
    ...
    signal: MetricSignal(deadbandK: 1.0),
    ui: MetricUi(label: 'Meals outside home', inputType: 'quick_count'),
    status: 'active',
    introducedIn: 'phase1',
    deprecatedAt: null,
  ),
  MetricDefinition(
    ...
    signal: MetricSignal(deadbandK: 1.0),
    ui: MetricUi(label: 'Mosquito bites', inputType: 'quick_count'),
    status: 'active',
    introducedIn: 'phase1',
    deprecatedAt: null,
  ),
