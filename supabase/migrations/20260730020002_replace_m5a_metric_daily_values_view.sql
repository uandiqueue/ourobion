...
select user_id,
       log_date,
       'appetite_score'::text as metric_key,
       appetite_score::double precision as value,
       'self_report'::text as source
  from public.daily_gut_rows
 where appetite_score is not null
union all
select user_id,
       log_date,
       'anxiety_score'::text as metric_key,
       anxiety_score::double precision as value,
       'self_report'::text as source
  from public.daily_gut_rows
 where anxiety_score is not null
union all
select user_id,
       log_date,
       'brain_clarity_score'::text as metric_key,
       brain_clarity_score::double precision as value,
       'self_report'::text as source
  from public.daily_gut_rows
 where brain_clarity_score is not null
union all
select user_id,
       log_date,
       'focus_score'::text as metric_key,
       focus_score::double precision as value,
       'self_report'::text as source
  from public.daily_gut_rows
...
select user_id,
       log_date,
       'social_interaction_quality_score'::text as metric_key,
       social_interaction_quality_score::double precision as value,
       'self_report'::text as source
  from public.daily_gut_rows
 where social_interaction_quality_score is not null
union all
select user_id,
       log_date,
