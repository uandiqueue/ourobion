...
> now-wrong statements. This file deliberately remains unrevised until the synthesis revamp in issue
> #300 and the parallel brain/rules work are integrated and re-verified. Model-training and
