...
> [`submission-verification-audit.md`](../../../temp/run4/submission-verification-audit.md).
...
| 14 verified edges, 11 servable, 0 `producer='edge'` cards | [`writeup.md`](./writeup.md) Appendix E; §4 above; hosted read 2026-08-02 |
