...
- Candidate attempts:
  - `docs/biotope/ui-context/ai-assets/reviews/candidates/empty_scan_bloom_attempt_1.png`
  - `docs/biotope/ui-context/ai-assets/reviews/candidates/empty_scan_bloom_attempt_2.png`
