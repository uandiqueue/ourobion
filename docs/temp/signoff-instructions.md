...
| U3 · LLM router | Jayden | C6/C7 (model-ids, caps, decorrelation) | `a419d8e` | ⏸ **HELD** — decorrelation must generalize (**O7**); maxOut/caps undocumented (**O8**); verifier id + synthesis-Opus at key-load (B5) |
