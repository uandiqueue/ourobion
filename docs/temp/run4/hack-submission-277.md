...
`docs/shared/hackathon/submission/writeup.md` (updated 2026-07-30) and its companion
...
- `docs/shared/hackathon/submission/writeup.md`, `system-connection-map.md` — the shared submission
  docs this file refreshes.
- `docs/temp/run4/hack-mvp-demo-script.md` — the demo runbook §6 corrects.
