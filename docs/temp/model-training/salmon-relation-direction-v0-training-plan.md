...
- the serve-path determinism invariant holds unconditionally — per
  [`decisions/0003-paper-reliability.md`](../../shared/decisions/0003-paper-reliability.md), serve-time
...
([`insight-engine-architecture.md`](../../shared/insight-engine-architecture.md) §A10), which fills the
check blocks. A secondary future seam is **A8 synthesis**, where
[`insight-engine-architecture.md` §10.2](../../shared/insight-engine-architecture.md) lists a
...
[`brain-support-models-design.md` §3](../../nao/brain-support-models-design.md) states that BioRED
