...
[`metrics-registry-design.md`](../implemented/biotope/metrics-registry-design.md) + [`shared/metrics/README.md`](../../shared/metrics/README.md);
the insights engine in [`rules-engine-design.md`](../implemented/biotope/rules-engine-design.md); the brain
pipeline in [`nao/brain-synthesis-design.md`](../implemented/nao/brain-synthesis-design.md) + [`nao/brain-support-models-design.md`](../implemented/nao/brain-support-models-design.md)
(anchor decision: [memory 0013](../memory/0013-brain-pipeline-and-support-models-decision.md); design in [`../nao/brain-synthesis-design.md`](../implemented/nao/brain-synthesis-design.md)).
...
- **No add or remove touches more than the registry and its generated/guarded edges** — see
  [`metrics-registry-design.md`](../implemented/biotope/metrics-registry-design.md) and the `metrics-registry-*` guards.
...
### W2 · Insights engine (M5b) + the brain — see [`rules-engine-design.md`](../implemented/biotope/rules-engine-design.md)
...
| Presentation agent (grounded NL) | On demand, the server retrieves the relevant brain subgraph and a **constrained** LLM phrases the wording — introducing **no relationship or number** outside the retrieved set, **copy-gated at render, cached, and degradable** to templated copy. The deterministic engine stays the authority for *what is true*; the agent only phrases *how it reads*. See [`rules-engine-design §E`](../implemented/biotope/rules-engine-design.md). |
| Paper → rules/edge extraction | The brain's ingestion + synthesis + adversarial verification pipeline turns the paper corpus into verified relationships; human-reviewed, budget-capped. See [`brain-synthesis-design.md`](../implemented/nao/brain-synthesis-design.md) + [`brain-support-models-design.md`](../implemented/nao/brain-support-models-design.md). |
...
gated on how much of the brain exists. Detail: [`nao/nao-app-design.md`](../implemented/nao/nao-app-design.md) (product +
phasing) · [`nao/brain-synthesis-design.md`](../implemented/nao/brain-synthesis-design.md) (edge synthesis + verification) ·
[`nao/brain-ingestion-design.md`](../implemented/nao/brain-ingestion-design.md) (paper corpus) ·
[`nao/brain-support-models-design.md`](../implemented/nao/brain-support-models-design.md) (support models). Pipeline decision:
...
1. **No GPU / GMI credits yet.** Support-model *training* can't start — credits aren't provisioned and
   ...
   [`brain-support-models-design.md`](../implemented/nao/brain-support-models-design.md)); training lands when GMI does. The **b2**
