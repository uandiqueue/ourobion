...
[`brain-support-models-design.md`](../../implemented/nao/brain-support-models-design.md). This pilot deliberately does
...
`../run3/pending-build-register.md` (`docs/archive/runs/run3/pending-build-register.md`, archived) under B-BR4/B6 only when the
