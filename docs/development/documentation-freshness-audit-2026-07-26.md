...
| [`insight-engine-architecture.md`](../implemented/insight-engine-architecture.md) | current architecture reference | Recently reconciled and explicitly authoritative across nao/biotope, provided design targets are not mistaken for hosted deployment proof |
