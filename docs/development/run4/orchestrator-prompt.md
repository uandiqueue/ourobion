...
When the human says `run docs/development/run4/orchestrator-prompt.md`, execute the block below. That
...
3. docs/development/run4/continuation-status.md — the live cockpit.
