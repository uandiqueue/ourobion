...
Numbering starts at **O31**. `O30` is deliberately skipped: it is a dead ID in `docs/development/` and a live
...
`docs/development/decisions/0003-paper-reliability.md`: it has
...
[`phase2-demo-runbook.md`](../phase2-demo-runbook.md)) already verifies relationship claims
...
- **`O30` is dead in `docs/development/` and live in the archive.** Run 4 numbering starts at O31 for this
