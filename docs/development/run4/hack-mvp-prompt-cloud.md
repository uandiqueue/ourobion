...
writes; docs/development/run4/pending-build-register.md B-PL19 requires "Jayden's separate approval of named
isolated rehearsal resources". Jayden has now directed this migration for the hackathon MVP. FIRST
ACTION: append that decision to docs/development/run4/human-decisions.md — date, exact scope (apply
...
Also fix the doc defect: docs/development/run4/orchestrator-prompt.md §6 prescribes a macOS setup for a
