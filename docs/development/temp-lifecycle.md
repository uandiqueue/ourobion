...
|---|---|---|
| `run3/` (`docs/archive/runs/run3/README.md`, archived) | Phase-2 Run 3.0: six product-only remediation and UI units, O24–O29 | planning locked; build not started |
...
`run3/pending-build-register.md` (`docs/archive/runs/run3/pending-build-register.md`, archived); archived records are provenance,
...
1. **Draft** in `docs/development/` (or `docs/development/briefs/` for a dated brief).
