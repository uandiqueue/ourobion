...
- **`docs/implemented/biotope/rules-engine-design.md` (IED), serve-side design:** the rules engine (IED §C)
...
- **`docs/implemented/nao/brain-synthesis-design.md` / `docs/implemented/nao/brain-ingestion-design.md`:** remain accurate for the
