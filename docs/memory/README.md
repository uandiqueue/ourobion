...
- [0013 — Brain pipeline + support-models decision (anchor)](0013-brain-pipeline-and-support-models-decision.md) — agentic seeder → deterministic ingest → synthesis LLM + verifier (different family) + 4 small support models → `verified_edges` truth store → Neo4j projection; runtime presentation agent. Anchor: the 2026-07-01 human-brief. → relational verified_edges projection (Neo4j dropped 2026-07-13)
